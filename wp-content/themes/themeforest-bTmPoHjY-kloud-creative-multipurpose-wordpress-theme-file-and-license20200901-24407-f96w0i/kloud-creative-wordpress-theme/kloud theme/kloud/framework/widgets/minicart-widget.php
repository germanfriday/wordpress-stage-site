	...
	class Bearstheme_Widget_Mini_Cart extends WC_Widget {
		...
		*/
		...
		function __construct() {
			...
			$this->widget_description = __( "Display the user's Cart in the sidebar.", 'kloud' );

			$this->widget_id          = 'bt_widget_mini_cart';

			$this->widget_name        = __( 'Mini Cart', 'kloud' );
