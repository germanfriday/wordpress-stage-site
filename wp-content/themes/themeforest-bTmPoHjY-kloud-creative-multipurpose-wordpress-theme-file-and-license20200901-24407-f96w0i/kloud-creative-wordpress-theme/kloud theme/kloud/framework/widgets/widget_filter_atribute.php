 ...
 * @extends  WC_Widget
 */
class kloud_Widget_Attributes_Filter extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce kloud_attributes_filter widget_layered_nav ';
		$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'kloud' );
		$this->widget_id          = 'kloud_attributes_filter';
		$this->widget_name        = esc_html__( 'kloud Attributes Filter', 'kloud' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'      => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Filter by', 'kloud' ),
				'label' => esc_html__( 'Title', 'kloud' )
			),
			'attribute'  => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'kloud' ),
				'options' => $attribute_array
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'kloud' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'kloud' ),
					'or'  => esc_html__( 'OR', 'kloud' )
				)
			),
		);
	}
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type, $show_color ) {
		...
		foreach ( $terms as $term ) {
			...
			echo apply_filters( 'kloud_color_filter_nav_count', '<span class="count-atr">(' . absint( $count ) . ')</span>', $count, $term );
