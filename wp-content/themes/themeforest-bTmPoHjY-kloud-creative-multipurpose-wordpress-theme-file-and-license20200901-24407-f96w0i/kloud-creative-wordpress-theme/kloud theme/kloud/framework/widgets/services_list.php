...
class jwstheme_Post_List_Widget extends jwstheme_Widget {
	function __construct() {
		parent::__construct(
			...
			__('Services List', 'kloud'), // Name
			array('description' => __('Display a list of your posts on your site.', 'kloud'),) // Args
        );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
			...
			'layout' => array(
				'type'  => 'select',
				'std'   => 'default',
				'label' => __( 'Layout', 'kloud' ),
				'options' => array(
					'default'  => __( 'Default', 'kloud' ),
					'layout2'  => __( 'Layout 2 - has thumbnail', 'kloud' ),
                    'layout3'  => __( 'Layout 3 - has thumbnai footer', 'kloud' ),
                    'layout4'  => __( 'Layout 4 - has thumbnai Click Show Content', 'kloud' ),
				)
			),
			'el_class'  => array(
				'type'  => 'text',
