...
class WC_Widget_Product_Categories2 extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'A list or dropdown of product categories.', 'kloud' );
		$this->widget_id          = 'woocommerce_product_categories';
		$this->widget_name        = __( 'WooCommerce product categories', 'kloud' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Product categories', 'kloud' ),
			...
			'dropdown' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show as dropdown', 'kloud' ),
			),
			'count' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show product counts', 'kloud' ),
			),
			'hierarchical' => array(
				'type'  => 'checkbox',
				'std'   => 1,
				'label' => __( 'Show hierarchy', 'kloud' ),
			),
			'show_children_only' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Only show children of the current category', 'kloud' ),
			),
			'hide_empty' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Hide empty categories', 'kloud' ),
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$list_args['show_option_none']           = __( 'No product categories exist.', 'kloud' );
