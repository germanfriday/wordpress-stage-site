...
class Zo_Recent_Posts_Widget_With_Thumbnails extends WP_Widget {
	...
	function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__('Recent Posts With Thumbnails', 'kloud'), // Name
            array('description' => esc_html__('List of your site&#8217;s most recent posts, with clickable title and thumbnails.', 'kloud'),) // Args
        );
				...
				<div class="tb-recent-detail">
                    ...
                    <?php if ( ! $hide_author ) { ?>
						<div class="tb-post-author">
							<p>		
								<?php 
								echo __('By ', 'kloud').'<span>'.get_the_author().'</span>'
								?>
							</p>
					...
					<?php if ( ! $hide_button ) { ?>
						<!-- Btn read mor -->
						<a href="<?php the_permalink(); ?>" class="btn btn-default"><?php esc_html_e('Read More', 'kloud');?></a>
					</div>	
					<?php }?>
				</div>				
		<?php endwhile; ?>
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_thumbnail' )); ?>"><?php esc_html_e( 'Do not show hide_thumbnail?', 'kloud' ); ?> <em><?php esc_html_e( 'Make sure you set a default thumbnail for posts without a tille.', 'kloud' ); ?></em></label> </p>
        
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'kloud' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>
        
		<p><label for="<?php echo esc_attr($this->get_field_id( 'number_posts' )); ?>"><?php esc_html_e( 'Number of posts to show:', 'kloud' ); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e( 'Display post date?', 'kloud' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_title' )); ?>"><?php esc_html_e( 'Do not show title?', 'kloud' ); ?> <em><?php esc_html_e( 'Make sure you set a default title for posts without a tille.', 'kloud' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_author' )); ?>"><?php esc_html_e( 'Do not show author?', 'kloud' ); ?> <em><?php esc_html_e( 'Make sure you set a default author for posts without a tille.', 'kloud' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_content' )); ?>"><?php esc_html_e( 'Do not show content?', 'kloud' ); ?> <em><?php esc_html_e( 'Make sure you set a default content for posts without a content.', 'kloud' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_button' )); ?>"><?php esc_html_e( 'Do not show button read more?', 'kloud' ); ?> <em><?php esc_html_e( 'Make sure you set a default button for posts without a button.', 'kloud' ); ?></em></label> </p>
