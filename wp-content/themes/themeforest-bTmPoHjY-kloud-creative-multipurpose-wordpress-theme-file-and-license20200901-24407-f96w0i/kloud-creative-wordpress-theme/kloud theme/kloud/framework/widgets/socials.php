...
class jwstheme_Social_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                ...
                __('Socials', 'kloud'), // Name
                array('description' => __('Social Widget', 'kloud'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'kloud'); ?></label>
        ...
        for ($i = 1; $i <= 6; $i++) {
            ?>
            <p>
                <label for="<?php echo esc_url($this->get_field_id('icon_social_' . $i)); ?>"><?php _e('Social Icon:', 'kloud');
            ...
            <p>
                <label for="<?php echo esc_url($this->get_field_id('link_social_' . $i)); ?>"><?php _e('Social Link:', 'kloud');
            echo wp_kses_post($i); ?></label>
        ...
        <?php } ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('el_class')); ?>"><?php _e('Extra Class:', 'kloud'); ?></label>
