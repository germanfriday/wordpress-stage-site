...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_html__( 'Web Safe Fonts', 'kloud' ) .'">';
      ...
      echo '<optgroup label="'. esc_html__( 'Google Fonts', 'kloud' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'kloud' );
