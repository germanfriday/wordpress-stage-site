	...
	class wc_ajax_cart_quantity {
		...
		*/		
		...
		function wc_ajax_cart_quantity_script() {
			...
			wp_localize_script( 'wc_ajax_cart_quantity_script', 'wc_ajax_cart_quantity_lang', array(
				'required' => __('Please enter a number.', 'kloud'),
				'number'   => __('Please enter a number.', 'kloud'),
				'min'	  => __('Please enter a value greater than or equal to 1.', 'kloud'),
			));
		}
		/**
		...
		*/
		function filter_plugin_actions($links, $file) {
		   $settings_link = '<a href="options-general.php?page=' . basename(__FILE__) . '">' . __('Settings' , 'kloud') . '</a>';
				...
				<table width="100%" cellspacing="2" cellpadding="5" class="form-table"> 
					<tr valign="top"> 
						...
						<td>
							...
							<br /><span class="setting-description"><?php _e('HELP TEXT1', 'kloud'); ?>
						</td> 
					</tr>
					<tr valign="top"> 
						<th width="33%" scope="row"><?php _e('Option2:', 'kloud'); ?></th> 
						<td>
							...
							<br /><span class="setting-description"><?php _e('HELP TEXT2', 'kloud'); ?>
						</td> 
					</tr>
				</table>
				<p class="submit"> 
					<input type="submit" name="wc_ajax_cart_quantity_save" class="button-primary" value="<?php _e('Save Changes', 'kloud'); ?>" />
				</p>
			</form>				
			<?php
		}
