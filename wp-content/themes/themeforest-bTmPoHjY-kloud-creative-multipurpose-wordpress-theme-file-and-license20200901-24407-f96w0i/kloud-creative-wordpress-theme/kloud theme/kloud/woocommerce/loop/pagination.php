...
$nav_layout = cs_get_option( 'wc-pagination' );
	$paging_id = 'kloud-shop-infinite-loading';
	$paging_class = 'infinite';
	$prev = '';
	$next = '<span id="jws-products-loading" class="dots-loading">  '.esc_html__( 'Load More', 'kloud' ).' ';
...
<nav class="woocommerce-pagination <?php echo esc_attr( $paging_class )?>" id="<?php echo esc_attr( $paging_id ); ?>">
	...
	?>
    <div class="loaded-product"><?php esc_html_e ('All Products Loaded.' , 'kloud') ?></div>
</nav>
<?php }else { ?>
