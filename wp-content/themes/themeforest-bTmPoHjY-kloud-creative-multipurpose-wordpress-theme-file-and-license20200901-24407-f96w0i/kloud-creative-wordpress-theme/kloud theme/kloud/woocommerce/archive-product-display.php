		...
		?>
					<div class="<?php if($turn_full_width == '1') {echo 'no_' ; } ?>container">
                      ...
                      <div class="product-container row">
                       <?php if($layout == 'left-sidebar' && !isset( $_GET['columns'] ) ) : ?>
                     ...
                     <?php endif; ?> 
                     <?php if ( have_posts() ) : ?>
                        <div class="action-filter-swaper rela <?php if($layout == 'left-sidebar'  && !isset( $_GET['columns'] ) || $layout == 'right-sidebar'  ) {  echo " col-sm-12 col-md-9" ;} ?> ">
                            <?php 
                            if($action_filter) {
						...
						<div class="bt-product-items<?php if($layout == 'left-sidebar'  && !isset( $_GET['columns'] ) || $layout == 'right-sidebar'  ) {  echo " col-sm-12 col-md-9" ;} ?> ">
