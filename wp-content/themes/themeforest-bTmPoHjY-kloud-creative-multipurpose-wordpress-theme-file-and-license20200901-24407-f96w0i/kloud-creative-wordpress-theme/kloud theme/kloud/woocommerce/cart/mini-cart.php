...
<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button edit-cart"><?php _e( 'Edit Cart', 'kloud' ); ?></a>
<?php endif;?> 
...
<ul class="cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
                        ...
                        <div class="quanty-ajax <?php if ( $_product->is_sold_individually() ) echo "hidden"; ?>">
                            <div class="jws-cart-panel-quantity-pricing">
                                <?php if ( $_product->is_sold_individually() ) : ?>
                                    <?php
                                        echo apply_filters( 'woocommerce_widget_cart_item_quantity', '<span class="quantity">' . esc_html__( 'Qty', 'kloud' ) . ': ' . $cart_item['quantity'] . '</span>', $cart_item, $cart_item_key );
                                    ?>
                                <?php else: ?>
                                    <div class="product-quantity" data-title="<?php _e( 'Quantity', 'kloud' ); ?>">
                                        <?php
    ...
    <li class="empty"><?php _e( 'No products in the cart.', 'kloud' ); ?></li>
...
<div class="jws-cart-panel-summary">
    ...
    <div class="jws-cart-panel-summary-inner">
        ...
        <p class="woocommerce-mini-cart__total total">
            <strong><?php _e( 'Subtotal', 'kloud' ); ?>:</strong>
        ...
        <p class="woocommerce-mini-cart__buttons buttons in_product">
            <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php _e( 'proceed to checkout', 'kloud' ); ?></a>
        </p>
        
        <?php endif; ?>
        <p class="woocommerce-mini-cart__buttons buttons out_product"><a class="button checkout wc-forward" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php _e( 'Continue Shopping', 'kloud' ) ?></a></p>			
