...
class Vispa_Widget_FW_Recent_Posts extends WP_Widget {

	function __construct() {
		$widget_ops = array( 'description' => esc_html__( "Recent Posts.", 'vispa' ) );

		parent::__construct( false, esc_html__( 'Fly Recent Posts', 'vispa' ), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$filepath = get_template_directory() . '/theme-includes/widgets/fw-recent-posts/views/widget.php';

		$data = array(
			'instance'      => $params,
			'title'         => $title,
			'before_widget' => '<div class="widget widget-posts">',
			'after_widget'  => '</div>',
		);
