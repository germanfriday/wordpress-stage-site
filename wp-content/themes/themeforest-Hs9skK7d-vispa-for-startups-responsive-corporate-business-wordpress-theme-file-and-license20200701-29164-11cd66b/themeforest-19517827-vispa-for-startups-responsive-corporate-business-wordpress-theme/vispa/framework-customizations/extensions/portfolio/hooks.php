...
/* Add thumbnails support to portfolio */
add_theme_support( 'post-thumbnails', array( 'fw-portfolio' ) );
/* Add commets support to portfolio */
add_post_type_support( 'fw-portfolio', 'comments' );
/* Add excerpt support to portfolio */
add_post_type_support('fw-portfolio', 'excerpt');


if ( ! function_exists( '_vispa_ext_portfolio_theme_action_set_posts_per_page' ) ) :
	function _vispa_ext_portfolio_theme_action_set_posts_per_page( $query ) {
		/**
	...
	add_action( 'pre_get_posts', '_vispa_ext_portfolio_theme_action_set_posts_per_page' );
endif;
