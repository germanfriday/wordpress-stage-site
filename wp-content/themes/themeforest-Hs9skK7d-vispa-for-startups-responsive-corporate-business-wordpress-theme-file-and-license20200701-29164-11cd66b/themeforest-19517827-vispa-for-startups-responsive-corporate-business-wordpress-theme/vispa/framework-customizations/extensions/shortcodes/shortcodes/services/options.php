	...
	'main'     => array(
		...
		'options' => array(
			...
			'title'     => array(
				...
				'desc'  => esc_html__( 'Enter service title', 'vispa' )
			),
			'desc'      => array(
				'type'  => 'wp-editor',
				'label' => esc_html__( 'Description', 'vispa' ),
				'desc'  => esc_html__( 'Enter service description', 'vispa' )
			),
			'class'     => array(
				'type'  => 'text',
			...
			'description_styling' => array(
				...
				'picker'  => array(
					'selected' => array(
						'type'         => 'switch',
						'value'        => 'no',
						'label'        => esc_html__( 'Description Styling', 'vispa' ),
						'desc'         => esc_html__( 'Enable custom styling', 'vispa' ),
						'left-choice'  => array(
							'value' => 'no',
							'label' => esc_html__( 'No', 'vispa' ),
