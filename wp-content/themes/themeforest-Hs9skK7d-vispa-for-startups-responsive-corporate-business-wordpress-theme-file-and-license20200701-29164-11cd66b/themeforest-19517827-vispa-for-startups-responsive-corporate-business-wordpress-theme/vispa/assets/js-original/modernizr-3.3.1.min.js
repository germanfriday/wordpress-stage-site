...
!function (window, document, undefined) {
    ...
    function injectElementWithStyles(A, e, t, n) {
        var r, o, i, d, a = "modernizr", s = createElement("div"), l = getBody();
    ...
    function testProps(A, e, t, n) {
        ...
        for (var i, d, a, s, l, c = ["modernizr", "tspan"]; !mStyle.style;)i = !0, mStyle.modElem = createElement(c.shift()), mStyle.style = mStyle.modElem.style;
    ...
    }), Modernizr.addTest("ie8compat", !window.addEventListener && !!document.documentMode && 7 === document.documentMode), Modernizr.addTest("json", "JSON"in window && "parse"in JSON && "stringify"in JSON), Modernizr.addTest("typedarrays", "ArrayBuffer"in window), Modernizr.addTest("webaudio", function () {
    ...
    ModernizrProto._prefixes = prefixes, Modernizr.addTest("contains", is(String.prototype.contains, "function")), Modernizr.addTest("notification", function () {
    ...
    isSVG || !function (A, e) {
        ...
        function d(A, t) {
            ...
            t = t || o(A);
            for (var r = t.frag.cloneNode(), i = 0, d = n(), a = d.length; a > i; i++)r.createElement(d[i]);
            return r
        }
        ...
        function s(A) {
            A || (A = e);
            var n = o(A);
            return !y.shivCSS || m || n.hasCSS || (n.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), f || a(A, n), A
        }
        ...
        function w(A) {
            ...
            var n, r, i = o(A), d = A.namespaces, a = A.parentWindow;
            return !z || A.printShived ? A : ("undefined" == typeof d[b] && d.add(b), a.attachEvent("onbeforeprint", function () {
                e();
                for (var o, i, d, a = A.styleSheets, s = [], c = a.length, p = Array(c); c--;)p[c] = a[c];
                for (; d = p.pop();)if (!d.disabled && B.test(d.media)) {
                    try {
                        o = d.imports, i = o.length
                    } catch (w) {
                        i = 0
                    }
        ...
        var m, f, g = "3.7.3", E = A.html5 || {}, h = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, v = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, M = "_html5shiv", P = 0, D = {};
        !function () {
            try {
        ...
        A.html5 = y, s(e);
        var B = /^$|\b(?:all|print)\b/, b = "html5shiv", z = !f && function () {
    ...
    !function () {
        ...
        try {
            ...
            var r, o, i, d, a, s = "Modernizr", l = "this.onmessage=function(e){postMessage(e.data)}";
            try {
                r = new Blob([l], {type: "text/javascript"})
            } catch (c) {
            }
            r || (o = new t, o.append(l), r = o.getBlob()), d = n.createObjectURL(r), i = new Worker(d), i.onmessage = function (A) {
    ...
    var atRule = function (A) {
        ...
        for (var r = 0; t > r; r++) {
            var o = prefixes[r], i = o.toUpperCase() + "_" + e;
    ...
    }), addTest("htmlimports", "import"in createElement("link")), Modernizr.addTest("olreversed", "reversed"in createElement("ol")), Modernizr.addTest("video", function () {
    ...
    }), Modernizr.addTest("audioloop", "loop"in createElement("audio")), Modernizr.addAsyncTest(function () {
        function A(t) {
            clearTimeout(e);
    ...
    Modernizr.addTest("todataurljpeg", function () {
        ...
        if (!A || !e)return t;
        var n = createElement("iframe"), r = createElement("div"), o = createElement("div"), i = createElement("div"), d = "modernizr_flow_for_regions_check";
        ...
        return o.style[e] = d, a = o.getBoundingClientRect(), s = parseInt(a.left - l.left, 10), docElement.removeChild(r), 42 == s ? t = !0 : (docElement.appendChild(n), l = n.getBoundingClientRect(), n.style[e] = d, a = n.getBoundingClientRect(), l.height > 0 && l.height !== a.height && 0 === a.height && (t = !0)), o = i = r = n = undefined, t
        ...
        var t = createElement("ruby"), n = createElement("rt"), r = createElement("rp"), o = "display", i = "fontSize";
        ...
        if (A = !("plugins"in navigator && "Shockwave Flash"in navigator.plugins || e), A || isSVG)r(!1); else {
            ...
            i = function () {
                return t(s), docElement.contains(s) ? (docElement.contains(a) ? (d = a.style.cssText, "" !== d ? r("blocked", a) : r(!0, a)) : r("blocked"), void n(s)) : (s = document.body || s, a = createElement("embed"), a.type = "application/x-shockwave-flash", s.appendChild(a), setTimeout(i, 1e3))
            }, setTimeout(i, 10)
        }
    });
    var mq = function () {
    ...
    blacklist ? Modernizr.addTest("fontface", !1) : testStyles('@font-face {font-family:"font";src:url("https://")}', function (A, e) {
        ...
        try {
            ...
            t.initKeyEvent("keypress", !0, !0, window, !1, !1, !1, !1, 0, "e".charCodeAt(0)), docElement.appendChild(e),
                e.addEventListener("input", n, !1), e.focus(), e.dispatchEvent(t), e.removeEventListener("input", n, !1), docElement.removeChild(e)
        } catch (r) {
            A = !1
        }
        return A
    ...
    Modernizr._q.push(function () {
    ...
    }), Modernizr.addTest("queryselector", "querySelector"in document && "querySelectorAll"in document), Modernizr.addTest("svg", !!document.createElementNS && !!document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), Modernizr.addTest("serviceworker", "serviceWorker"in navigator), Modernizr.addTest("touchevents", function () {
        var A;
    ...
    }), Modernizr.addTest("userdata", !!createElement("div").addBehavior), testStyles("#modernizr1{width: 50vmax}#modernizr2{width:50px;height:50px;overflow:scroll}#modernizr3{position:fixed;top:0;left:0;bottom:0;right:0}", function (A) {
        var e = A.childNodes[2], t = A.childNodes[1], n = A.childNodes[0], r = parseInt((t.offsetWidth - t.clientWidth) / 2, 10), o = n.clientWidth / 100, i = n.clientHeight / 100, d = parseInt(50 * Math.max(o, i), 10), a = parseInt((window.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle).width, 10);
        ...
        var e = A.childNodes[2], t = A.childNodes[1], n = A.childNodes[0], r = parseInt((t.offsetWidth - t.clientWidth) / 2, 10), o = n.clientWidth / 100, i = n.clientHeight / 100, d = parseInt(50 * Math.min(o, i), 10), a = parseInt((window.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle).width, 10);
        Modernizr.addTest("cssvminunit", roundedEquals(d, a) || roundedEquals(d, a - r))
    }, 3), Modernizr.addTest("vml", function () {
    ...
    }), Modernizr.addTest("webanimations", "animate"in createElement("div")), Modernizr.addTest("websockets", "WebSocket"in window && 2 === window.WebSocket.CLOSING), Modernizr.addTest("adownload", !window.externalHost && "download"in createElement("a")), Modernizr.addTest("xdomainrequest", "XDomainRequest"in window);
    ...
    }), Modernizr.addTest("intl", !!prefixed("Intl", window)), Modernizr.addTest("lowbattery", function () {
    ...
    url = url && window[url], Modernizr.addTest("bloburls", url && "revokeObjectURL"in url && "createObjectURL"in url), Modernizr.addAsyncTest(function () {
        ...
        try {
            var n, r, o = 'var hello = "world"', i = new Blob([o], {type: "text/javascript"}), d = URL.createObjectURL(i), a = new Worker(d);
        ...
        return !1
    }), Modernizr.addTest("matchmedia", !!prefixed("matchMedia", window)), Modernizr.addTest("pagevisibility", !!prefixed("hidden", document, !1)), Modernizr.addTest("performance", !!prefixed("performance", window)), Modernizr.addTest("pointerlock", !!prefixed("exitPointerLock", document)), Modernizr.addTest("quotamanagement", function () {
        var A = prefixed("temporaryStorage", navigator), e = prefixed("persistentStorage", navigator);
        return !(!A || !e)
    }), Modernizr.addTest("requestanimationframe", !!prefixed("requestAnimationFrame", window), {aliases: ["raf"]}), Modernizr.addTest("vibrate", !!prefixed("vibrate", navigator)), Modernizr.addTest("webintents", !!prefixed("startActivity", navigator)), ModernizrProto.testAllProps = testAllProps, Modernizr.addTest("ligatures", testAllProps("fontFeatureSettings", '"liga" 1')), Modernizr.addTest("cssanimations", testAllProps("animationName", "a", !0)), Modernizr.addTest("csspseudoanimations", function () {
        var A = !1;
        ...
        function A() {
            function t() {
                try {
                    var A = createElement("div"), e = createElement("span"), t = A.style, n = 0, r = 0, o = !1, i = document.body.firstElementChild || document.body.firstChild;
            ...
            function n(A, e) {
                try {
                    var t = createElement("div"), n = createElement("span"), r = t.style, o = 0, i = !1, d = !1, a = !1, s = document.body.firstElementChild || document.body.firstChild;
