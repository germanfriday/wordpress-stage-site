...
?>
<!-- Post -->
<article id="post-<?php the_ID(); ?>" <?php post_class( 'article card card-blog card-white' ); ?>>
	<div class="inner">
		<div class="header">
		...
		<div class="content">
			...
			<?php endif; ?>
			<a href="<?php echo esc_url( $vispa_permalink ); ?>" class="card-title"><h3><?php the_title(); ?></h3></a>
			<?php if( $vispa_post_categories == 'yes' ) : ?>
				<h6 class="card-category text-warning"><?php vispa_theme_get_one_post_category($post->ID); ?></h6>
			<?php endif; ?>
