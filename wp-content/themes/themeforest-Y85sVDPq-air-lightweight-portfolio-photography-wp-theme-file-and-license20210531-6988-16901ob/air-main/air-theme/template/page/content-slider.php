<?php
$enable_slider = airtheme_get_post_meta(get_the_ID(), 'theme_meta_enable_slider');
$slider_source = airtheme_get_post_meta(get_the_ID(), 'theme_meta_slider_source');
	...
	if($enable_slider){
		switch($slider_source){
			case 'revolution-slider':
				$revolution_slider = airtheme_get_post_meta(get_the_ID(), 'theme_meta_select_revolution_slider');
			...
			case 'bmslider':
				$bmslider = airtheme_get_post_meta(get_the_ID(), 'theme_meta_select_bmslider');
